  ...
  return (
    <div className=" mt-4 border p-3 bg-white">
                    ...
                    <form className=" " onChange={(e)=>handleJobsChange(e.target.value, e.target.name)
                        ...
                        <label className=""  >
                            <input type="radio" name="minSalary" value="15000" checked={salaryMin == 15000}  />
                            <span className="ml-2 ">below 15,000</span>
                            <br />
                        </label>
                        <label className=""  >
                            <input type="radio" name="minSalary" value="16000-30000" checked = {salaryMin==16000 && salaryMax==30000} />
                            <span className="ml-2 ">
                                16,000 - 30,000
                            </span>
                            <br />
                        ...
                        <label className=""  >
                            <input type="radio" name="minSalary" value="30000-50000" checked = {salaryMin==30000 && salaryMax==50000}/>
                            <span className="ml-2 ">30,000-50,000</span>
                            <br />
                        </label>
                        <label className=""  >
                            <input type="radio" name="minSalary" value="50000-800000" checked = {salaryMin==50000 && salaryMax==800000}/>
                            <span className="ml-2 ">50,000 - 80,000</span>
                            <br />
                        </label>
                        <label className=""  >
                            <input type="radio" name="minSalary" value="100000" checked = {salaryMax==100000}/>
